...
**Vertical scaling has performance cap while horizontal scaling has no upper bound**: vertical scaling can only bump your performance up to the latest hardware’s capabilities. These capabilities prove to be insufficient for technological companies with moderate to big workloads.
